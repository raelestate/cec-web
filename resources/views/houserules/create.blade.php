<x-app-layout>
    ...
    <form method="POST" action="{{ route('houserules.store') }}" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <textarea type="text" name="houserules_text" id="houserules_text" placeholder="House Rules Text"
