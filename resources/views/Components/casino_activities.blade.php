...
?>
<div>
    <div class="container flex flex-col justify-center items-center rounded-xl">
        <h3 class="bg-cyan-900 text-white text-lg font-bold px-4 py-5 rounded-t-xl w-full">CASINO EVENT:
